  ...
  return (
    <div className="form__header">
      <div className="flex lg:block items-center gap-6 flex-row-reverse">
        <Image src={imgFamily} alt="Familia" width={136} height={160} className="block lg:hidden" />
        <div className="w-full lg:mb-0">
          ...
          <h1 className="font-bold text-2xl lg:text-4xl mb-2">Creado para ti y tu familia</h1>
        </div>
      </div>
